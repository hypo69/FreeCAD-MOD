...
Предоставляет редактор для создания и изменения текстовых файлов
с промптами для AI.

.. module:: AIEngineer.dialogs.text_editor
"""
...
class TextEditorDialog(QtGui.QDialog):
    ...
    def __init__(self, filepath: Path = None):
        """
        Функция инициализирует редактор текста.

        Args:
            filepath (Path): Путь к редактируемому файлу (опционально).
        """
        super().__init__()
